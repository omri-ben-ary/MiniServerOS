...
server: server.o request.o segel.o Node.o Queue.o RequestManager.o HandlerThreadStats.o
	$(CC) $(CFLAGS) -o server server.o request.o segel.o Node.o Queue.o RequestManager.o HandlerThreadStats.o $(LIBS)
